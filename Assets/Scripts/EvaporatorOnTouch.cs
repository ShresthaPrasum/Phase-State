...
public class EvaporatorOnTouch : MonoBehaviour
{
    [Header("Detection")]
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        TryEvaporate(collision.gameObject);
    }
    ...
    private void TryEvaporate(GameObject candidate)
    {
        ...
        if (controller.GetCurrentState() != PlayerInstabilityController.PhaseState.Liquid)
        {
            return;
        }
